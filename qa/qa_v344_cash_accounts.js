...
check(pkg.version==='30.51.0'&&lock.version==='30.51.0'&&lock.packages[''].version==='30.51.0','versioned package and lockfile');
check(index.includes('/v344-client.js?v=30.51.0')&&index.indexOf('/v343-client.js')<index.indexOf('/v344-client.js'),'V30.44 client retained before V30.45');
check(read('server/server.js').includes("version:'30.51.0'"),'health release identity');
...
console.log('V30.51.0 Cash & Bank persistent action behavior QA: PASS');
