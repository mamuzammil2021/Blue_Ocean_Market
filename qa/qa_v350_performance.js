...
(async()=>{
 ...
 check(pkg.version==='30.52.0'&&lock.version==='30.52.0'&&lock.packages[''].version==='30.52.0','version identity and lockfile');
 ...
 check(index.includes('/v351-loader.js?v=30.52.0')&&!index.includes('<script src="/v350-import-pages.js')&&read('public/v351-loader.js').includes("psImports:'pink-imports'"),'import read module lazily loads on its own screen');
