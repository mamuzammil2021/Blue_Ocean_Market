...
check(f&&f.version==='30.45.0','new shared coordinator exports V30.51.0');
...
check(idx.includes('/v345-client.js?v=30.51.0')&&idx.indexOf('/v345-client.js')>idx.indexOf('/v344-client.js'),'V30.45 served after protected V30.44 account actions');
...
check(pkg.version==='30.51.0'&&lock.version==='30.51.0'&&read('server/server.js').includes("version:'30.51.0'"),'package, lock and server release identity updated');
