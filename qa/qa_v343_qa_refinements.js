...
must(pkg.version==='30.52.0','current package version required');
has(pkg.scripts['qa:v343']||'','qa_v343_qa_refinements.js','qa:v343 script missing');
has(idx,'/v343-client.js?v=30.52.0','V30.43 client must load from index');
...
has(main,'Blue Ocean Market V30.52.0 running','runtime release identity missing');
...
has(idx,'/v342-client.js?v=30.52.0','V30.42 client layer must remain');
