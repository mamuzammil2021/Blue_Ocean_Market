...
must(pkg.version==='30.43.0','package version must be 30.43.0');
has(pkg.scripts['qa:v343']||'','qa_v343_qa_refinements.js','qa:v343 script missing');
has(idx,'/v343-client.js?v=30.43.0','V30.43 client must load from index');
...
has(main,'Blue Ocean Market V30.43.0 running','runtime release identity missing');
...
has(idx,'/v342-client.js?v=30.43.0','V30.42 client layer must remain');
