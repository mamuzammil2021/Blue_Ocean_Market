...
check('V30.32 implementation is retained in current release',backend.includes("VERSION='30.32.0'")&&server.includes("require('./v332').install")&&index.includes('/v332-client.js?v=30.38.0'));
check('V30.32 browser overlay loads after V30.31',index.indexOf('/v331-client.js?v=30.38.0')<index.indexOf('/v332-client.js?v=30.38.0'));
