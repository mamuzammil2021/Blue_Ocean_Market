...
check('Current V30.38.1 release identity retains V30.37',p.version==='30.38.1'&&lock.version==='30.38.1'&&lock.packages?.['']?.version==='30.38.1'&&s.includes("version:'30.38.1'")&&s.includes('Blue Ocean Market V30.38.1 running on port'));
...
check('V30.37 client overlay retained before V30.38',i.includes('/v337-client.js?v=30.38.1')&&i.indexOf('/v336-client.js?v=30.38.1')<i.indexOf('/v337-client.js?v=30.38.1'));
