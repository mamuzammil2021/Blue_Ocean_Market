...
check('V30.34 baseline retained in current release',Number(String(p.version).split('.')[1])>=34&&s.includes("version:'30.38.2'")&&b.includes("VERSION='30.34.0'"));
check('V30.34 browser overlay loads after V30.33',i.includes('/v334-client.js?v=30.38.2')&&i.indexOf('/v333-client.js?v=30.38.2')<i.indexOf('/v334-client.js?v=30.38.2')&&i.indexOf('/v334-client.js?v=30.38.2')<i.indexOf('/v335-client.js?v=30.38.2'));
