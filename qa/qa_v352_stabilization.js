...
pass('V30.52 source and lock identity',pkg.version==='30.54.0'&&lock.version==='30.54.0'&&lock.packages[''].version==='30.54.0'&&server.includes("version:'30.54.0'"));
...
pass('V30.51 optimized loader remains active',index.includes('v351-loader.js?v=30.54.0')&&index.includes('v352-client.js?v=30.54.0')&&index.indexOf('v352-client.js')>index.indexOf('v351-loader.js'));
