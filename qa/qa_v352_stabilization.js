...
pass('V30.52 source and lock identity',pkg.version==='30.53.0'&&lock.version==='30.53.0'&&lock.packages[''].version==='30.53.0'&&server.includes("version:'30.53.0'"));
...
pass('Point 1: current and legacy cost UI share correct lock conditions',c343.includes("return as==='Posted'||['Verified / Correct','Verified'].includes(vs)")&&runtime.includes("['Verified / Correct','Verified'].includes(txt(x.finance_verification_status))"));
...
pass('V30.51 optimized loader remains active',index.includes('v351-loader.js?v=30.53.0')&&index.includes('v352-client.js?v=30.53.0')&&index.indexOf('v352-client.js')>index.indexOf('v351-loader.js'));
