...
check('current release version and cache identity',pkg.version==='28.3.0'&&server.includes("version:'28.3.0'")&&html.includes('/client.js?v=28.3.0')&&html.includes('/i18n-ko.js?v=28.3.0'));
...
if(failed){console.error(`V27.8 Korean-first QA failed: ${failed}`);process.exit(1)}
console.log(`V27.8 Korean-first QA PASS (${Object.keys(ko).length} exact phrases, ${patterns.length} runtime patterns)`);
