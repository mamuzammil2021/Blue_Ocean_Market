...
ok(pkg.version==='30.52.0'&&lock.version==='30.52.0'&&lock.packages[''].version==='30.52.0','package/lock release version');
ok(server.includes("version:'30.52.0'")&&server.includes('Blue Ocean Market V30.52.0 running'),'health/log release identity');
ok(html.includes('/bom-mutation-hub.js?v=30.52.0')&&html.indexOf('bom-mutation-hub.js')<html.indexOf('runtime-v30392.js'),'shared node dispatcher installed before compatibility runtime');
ok(html.includes('/v345-client.js?v=30.52.0')&&html.indexOf('/v345-client.js')<html.indexOf('/v346-client.js'),'protected V30.45 feedback coordinator precedes new scheduler');
