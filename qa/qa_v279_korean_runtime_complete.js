...
check('V27.9 version and cache identity',pkg.version==='27.9.0'&&server.includes("version:'27.9.0'")&&html.includes('/client.js?v=27.9.0')&&html.includes('/i18n-ko.js?v=27.9.0'));
