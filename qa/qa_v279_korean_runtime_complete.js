...
check('V27.9+ version and cache identity',pkg.version==='28.1.0'&&server.includes("version:'28.1.0'")&&html.includes('/client.js?v=28.1.0')&&html.includes('/i18n-ko.js?v=28.1.0'));
