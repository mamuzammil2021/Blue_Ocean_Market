...
check('V30.33 implementation retained in V30.34 release',p.version==='30.38.1'&&s.includes("version:'30.38.1'")&&b.includes("VERSION='30.33.0'"));
check('V30.33 browser overlay retained before newer stability overlays',i.includes('/v333-client.js?v=30.38.1')&&i.indexOf('/v332-client.js?v=30.38.1')<i.indexOf('/v333-client.js?v=30.38.1')&&i.indexOf('/v333-client.js?v=30.38.1')<i.indexOf('/v334-client.js?v=30.38.1'));
