...
check(pkg.version==='30.51.0'&&lock.version==='30.51.0'&&lock.packages[''].version==='30.51.0'&&server.includes("version:'30.51.0'"),'release identity consistent');
check(index.includes('/v351-loader.js?v=30.51.0')&&index.indexOf('v351-loader.js')>index.indexOf('v348-loader.js'),'optional route loader installed after protected wrappers');
...
check(index.includes('/v349-accounting-pages.js?v=30.51.0')&&index.includes('/runtime-v30392.js?v=30.51.0')&&index.includes('/v345-client.js?v=30.51.0'),'direct Accounting tab, business runtime, and unified feedback remain eager');
