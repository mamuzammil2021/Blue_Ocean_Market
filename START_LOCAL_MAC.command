...
if [ ! -f .env ]; then
  echo "Creating local-only .env for Blue Ocean Market V30.26.4..."
...
echo "Running Blue Ocean Market V30.26.4 release QA..."
npm run qa:current || exit 1

echo "Starting Blue Ocean Market V30.26.4 Local Test"
npm start
