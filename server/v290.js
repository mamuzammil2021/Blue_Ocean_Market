...
function install({app,db,auth,allow,currentUnit,enforceUnit,isFinanceReviewer,audit,notify,uploads,hasAccess}){
  ...
  function postJournal({businessUnitId,transactionDate,sourceType,sourceId,sourceLabel,description,financeEntryId=null,sourceHash='',createdBy=null,lines,postingStatus='Pending Review'}){
    ...
    const jNo=nextNo('JE','accounting_journal_entries'),r=db.prepare(`INSERT INTO accounting_journal_entries(journal_no,business_unit_id,transaction_date,source_type,source_id,source_label,description,finance_entry_id,source_hash,status,created_by) VALUES(?,?,?,?,?,?,?,?,?,?,?)`)
